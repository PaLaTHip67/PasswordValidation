...
public class TestRunner {
    ...
    public static void main(String[] a) {
        ...
        check("password len = 20", PasswordValidator.validate("Abcdef12") == true);
        check("password len < 8", PasswordValidator.validate("Abcdef1") == false);
        check("password len > 20", PasswordValidator.validate("Abcdef12Abcdef12Abcdef12") == false);
        ...
        check("password no number", PasswordValidator.validate("AAAAABBBB") == false);
        ...
        check("password is have 67", PasswordValidator.validate("67") == false);
